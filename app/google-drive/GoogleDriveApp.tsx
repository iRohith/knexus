        ...
        <ScrollArea className="min-h-0 flex-1">
          <div className="grid gap-4 p-4 xl:grid-cols-[1fr_22rem]">
            ...
            <Preview
              ...
              onDelete={() => selectedItem && deleteItem(selectedItem.id, activeUser.id)}
            />
          </div>
        </ScrollArea>
      </section>
    ...
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
      {items.map((item) => (
        ...
        >
          ...
          <div className="mt-4 h-28 overflow-hidden rounded-lg bg-[#f1f3f4] p-3 text-xs text-muted-foreground dark:bg-[#303134]">
